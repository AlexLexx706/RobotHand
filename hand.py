...
class Hand:
    ...
    def __init__(self):
        ...
        self.b0 = Bone(frame=self.base, pos=(0, 0, 0), freedom_x_angle=(atr(-65), atr(90)))
        self.b0_celinder = cylinder(frame=self.b0, pos=(0, 0, 0), axis=(-30,0,0), radius=20)

        self.b1 = Bone(frame=self.b0, pos=(0, 0, 0), freedom_z_angle=(atr(-135), 0))
        ...
        self.b2 = Bone(frame=self.b1, pos=(0, 0, 0), freedom_y_angle=(atr(-180), 0))
        ...
        self.b3 = Bone(frame=self.b2, pos=(0, -165, 0), freedom_z_angle=(0, atr(110)))
        self.b3_box = box(frame=self.b3, pos=(0, -85/2, 0), length=30, height=90, width=45)
        
        self.b4 = Bone(frame=self.b3, pos=(0, -85, 0), freedom_y_angle=(atr(-80), atr(90)))
    ...
    def set_save_state(self):
        ...
        if self.cmd_queue is not None:
            self.cmd_queue.put((1, [[k, self.fun_map[k]["get_angle"]()] for k in self.fun_map if self.fun_map[k]["enable"]]))
